...
//Sub2Catagories All Routes
  ...
  //Second Banner
  Route::get('/secondbanner', 'BannerController@showSecondbanner')->name('admin.secondbanner');
  Route::get('/secondbannerForm', 'BannerController@showSecondbannerUploadForm')->name('admin.secondbannerUploadForm');
  Route::post('/secondbanner/upload', 'BannerController@SecondbannerStore')->name('admin.secondbanner.store');
  Route::get('/secondbanner/edit/{id}', 'BannerController@SecondbannerEdit')->name('admin.secondbanner.edit');
  Route::post('/secondbanner/update/{id}', 'BannerController@SecondbannerUpdate')->name('admin.secondbanner.update');
  Route::post('/secondbanner/delete/{id}', 'BannerController@SecondbannerDelete')->name('admin.secondbanner.delete');
  //Third Banner
  Route::get('/thirdbanner', 'BannerController@showThirdbanner')->name('admin.thirdbanner');
  Route::get('/thirdbannerForm', 'BannerController@showThirdbannerUploadForm')->name('admin.thirdbannerUploadForm');
  Route::post('/thirdbanner/upload', 'BannerController@ThirdbannerStore')->name('admin.thirdbanner.store');
  ...
  //Third Banner
  Route::get('/fifthbanner', 'BannerController@showFifthbanner')->name('admin.fifthbanner');
  Route::get('/fifthbannerForm', 'BannerController@showFifthbannerUploadForm')->name('admin.fifthbannerUploadForm');
  Route::post('/fifthbanner/upload', 'BannerController@FifthbannerStore')->name('admin.fifthbanner.store');
  Route::get('/fifthbanner/edit/{id}', 'BannerController@FifthbannerEdit')->name('admin.fifthbanner.edit');
  Route::post('/fifthbanner/update/{id}', 'BannerController@FifthbannerUpdate')->name('admin.fifthbanner.update');
  Route::post('/fifthbanner/delete/{id}', 'BannerController@FifthbannerDelete')->name('admin.fifthbanner.delete');
