        ...
        <div class="bnr">
          ...
          <div class="bnnr4-slider">
            @foreach ($secondbanners as $secondbanner)
              <img src={{ url('storage/banners/'.$secondbanner->images) }} alt="slider">
            @endforeach
          </div>
          {{-- <button class="bnnr1-btn-right slider-btn"><i class="fas fa-chevron-right"></i></button> --}}
        </div>
        ...
        <div class="bnr">
          ...
          <div class="bnnr4-slider">
            @foreach ($thirdbanners as $thirdbanner)
              <img src={{ url('storage/banners/'.$thirdbanner->images) }} alt="slider">
            @endforeach
          </div>
          {{-- <button class="bnnr1-btn-right slider-btn"><i class="fas fa-chevron-right"></i></button> --}}
        </div>
    ...
    <div class="row">
      <div class="col-md-12 col-lg-12 col-sm-12 col-12">
        <div class="bnr">
          <button class="bnnr1-btn-left slider-btn"><i class="fas fa-chevron-left"></i></button>
          <div class="bnnr1-slider">
            @foreach ($fourthbanners as $fourthbanner)
              <img src={{ url('storage/banners/'.$fourthbanner->images) }} alt="slider">
            @endforeach
          </div>
          <button class="bnnr1-btn-right slider-btn"><i class="fas fa-chevron-right"></i></button>
        </div>
