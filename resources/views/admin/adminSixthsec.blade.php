...
@section('content')
          ...
          @foreach ($sixthsecs as $sixthsec)
            @if ($sixthsec->products_id == $product->id)
              ...
              <td>
                ...
                <form class="" action="{{ route('admin.sixthsec.delete', $product->id) }}" method="post">
                  @csrf
                    <input type="submit" name="Sixthsec" value="Delete">
    ...
    <div class="col-md-12 text-center">
      <a href="{{ route('admin.sixthsec.add.catagory') }}">Add New DOTD</a>
    </div>
