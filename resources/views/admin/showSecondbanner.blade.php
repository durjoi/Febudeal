      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 text-right">
            <a href="{{ route('admin.secondbannerUploadForm') }}" class="navbar__banner_btn">Upload New</a>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="row">
              <div class="col-md-12 col-lg-12 text-center">
                <div class="bannr__position text-center">
                  <p>Banner: {{ $i }}</p>
                  <a href="{{ route('admin.secondbanner.edit',$banner->id)  }}">Edit</a>
                  <a href="#"><form class="" action="{{ route('admin.secondbanner.delete', $banner->id) }}" method="post">
                    @csrf
