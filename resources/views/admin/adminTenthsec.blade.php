...
@section('content')
          ...
          @foreach ($tenthsecs as $tenthsec)
            @if ($tenthsec->products_id == $product->id)
              ...
              <td>
                ...
                <form class="" action="{{ route('admin.tenthsec.delete', $product->id) }}" method="post">
                  @csrf
                    <input type="submit" name="tenthsec" value="Delete">
    ...
    <div class="col-md-12 text-center">
      <a href="{{ route('admin.tenthsec.add.catagory') }}">Add New DOTD</a>
    </div>
