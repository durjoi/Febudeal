...
@section('content')
          ...
          @foreach ($eightsecs as $eightsec)
            @if ($eightsec->products_id == $product->id)
              ...
              <td>
                ...
                <form class="" action="{{ route('admin.eightsec.delete', $product->id) }}" method="post">
                  @csrf
                    <input type="submit" name="Eightsec" value="Delete">
    ...
    <div class="col-md-12 text-center">
      <a href="{{ route('admin.eightsec.add.catagory') }}">Add New DOTD</a>
    </div>
