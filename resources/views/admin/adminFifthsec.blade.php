...
@section('content')
          ...
          @foreach ($fifthsecs as $fifthsec)
            @if ($fifthsec->products_id == $product->id)
              ...
              <td>
                ...
                <form class="" action="{{ route('admin.fifthsec.delete', $product->id) }}" method="post">
                  @csrf
                    <input type="submit" name="Fifthsec" value="Delete">
    ...
    <div class="col-md-12 text-center">
      <a href="{{ route('admin.fifthsec.add.catagory') }}">Add New DOTD</a>
    </div>
